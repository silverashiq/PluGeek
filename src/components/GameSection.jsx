    ...
    <div>
        ...
        <section class="bg-gray-900 py-16">
          <div class="container mx-auto px-6 text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div class="bg-gray-800 p-6 rounded-lg hover:shadow-2xl transform hover:scale-105 transition-all">
                <img
                  src={PcGames}
                  alt="PC Gaming"
                  class="w-full h-48 object-cover rounded-t-lg"
                ></img>
                <h3 class="text-2xl text-white font-semibold mt-4">PC Gaming</h3>
                ...
                <div>
                  <div class="mb-4 text-left">
                    <h4 class="text-xl font-semibold text-green-500">Pros</h4>
                  ...
                  <div class=" text-left">
                    <h4 class="text-xl font-semibold text-red-500">Cons</h4>
                    <ul class="list-disc list-inside text-gray-400">
              ...
              <div class="bg-gray-800 p-6 rounded-lg hover:shadow-2xl transform hover:scale-105 transition-all">
                <img
                  ...
                  class="w-full h-48 object-cover rounded-t-lg"
                ></img>
                <h3 class="text-2xl text-white mt-4 font-semibold">Console Gaming</h3>
                <p class="text-gray-400 mt-2 text-xl">
              ...
              <div class="bg-gray-800 p-6 rounded-lg hover:shadow-2xl transform hover:scale-105 transition-all">
                <img
                  ...
                  class="w-full h-48 object-cover rounded-t-lg"
                ></img>
                <h3 class="text-2xl text-white mt-4 font-semibold">Mobile Gaming</h3>
                <p class="text-gray-400 mt-2 text-xl">
      ...
      <div>
        <section class="bg-slate-800 *:py-16">
          <div class="container mx-auto px-6 text-center">
            <h2 class="text-4xl font-bold text-white mb-12">Advantages of Gaming</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div class="bg-gray-700 p-6 rounded-lg hover:shadow-2xl transform hover:scale-105 transition-all">
                <h3 class="text-2xl text-white mb-4">Cognitive Benefits</h3>
              ...
              <div class="bg-gray-700 p-6 rounded-lg hover:shadow-2xl transform hover:scale-105 transition-all">
                <h3 class="text-2xl text-white mb-4">Social Interaction</h3>
                <p class="text-gray-400">
              ...
              <div class="bg-gray-700 p-6 rounded-lg hover:shadow-2xl transform hover:scale-105 transition-all">
                <h3 class="text-2xl text-white mb-4">Stress Relief</h3>
                <p class="text-gray-400">
